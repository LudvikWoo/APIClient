...
public class CommoditItem implements java.io.Serializable {
    ...
    public CommoditItem() {
        super();
    } //-- com.guoyasoft.commodity.beans.test.CommoditItem()
    ...
    **/
     ...
     * @param reader
    **/
    public static com.guoyasoft.commodity.beans.test.CommoditItem unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.guoyasoft.commodity.beans.test.CommoditItem) Unmarshaller.unmarshal(com.guoyasoft.commodity.beans.test.CommoditItem.class, reader);
    } //-- com.guoyasoft.commodity.beans.test.CommoditItem unmarshal(java.io.Reader) 
